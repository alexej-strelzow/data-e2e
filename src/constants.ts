 ...
 */
const DATA_E2E: string = process.env.DATA_E2E || 'data-e2e';

/**
 * Is the attribute empty? data-e2e-<selector> vs data-e2e="<selector>"
 */
const DATA_E2E_EMPTY: boolean = process.env.DATA_E2E_EMPTY !== 'false';

/**
 * Marker for a test-id that the same (w.o. suffix) already exists in the document
 */
const COLLISION_SUFFIX: string = process.env.COLLISION_SUFFIX || 'TODO-COLLISION';
